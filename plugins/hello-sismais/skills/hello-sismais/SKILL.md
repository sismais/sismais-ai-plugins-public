...
3. Link para o README: `https://github.com/sismais/sismais-ai-plugins-public`.
4. Sugestão de próximos passos: explorar os outros plugins do marketplace (mencione que o usuário pode listar via `/plugin` no Claude Code, sem garantir um subcomando específico).
